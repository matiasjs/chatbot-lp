...
const openai_client_service_1 = require("./openai-client.service");
...
exports.OpenAIModule = OpenAIModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [openai_client_service_1.OpenAIClientService],
        exports: [openai_client_service_1.OpenAIClientService],
    })
], OpenAIModule);
